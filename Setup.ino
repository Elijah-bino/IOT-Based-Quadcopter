...
byte channel_1_assign=0b00000001, channel_2_assign= 0b10000010, channel_3_assign= 0b00000011, channel_4_assign= 0b00000100;
byte roll_axis, pitch_axis, yaw_axis;
byte receiver_check_byte, gyro_check_byte;
volatile int receiver_input_channel_1, receiver_input_channel_2, receiver_input_channel_3, receiver_input_channel_4;
int center_channel_1= 1500, center_channel_2= 1500, center_channel_3= 1500, center_channel_4= 1500;
int high_channel_1= 2000, high_channel_2= 2000, high_channel_3= 2000, high_channel_4= 2000;
int low_channel_1= 1000, low_channel_2= 1000, low_channel_3= 1000, low_channel_4= 1000;
int address, cal_int;
...
void check_receiver_inputs(byte movement){
  ...
  while(timer > millis() && trigger == 0){
    delay(250);
    if(receiver_input_channel_1 > 1450 || receiver_input_channel_1 < 1250){
      trigger = 1;
      receiver_check_byte |= 0b00000001;
      pulse_length = receiver_input_channel_1;
    }
    if(receiver_input_channel_2 > 1450 || receiver_input_channel_2 < 1250){
      trigger = 2;
      receiver_check_byte |= 0b00000010;
      pulse_length = receiver_input_channel_2;
    }
    if(receiver_input_channel_3 > 1450 || receiver_input_channel_3 < 1250){
      trigger = 3;
      receiver_check_byte |= 0b00000100;
      pulse_length = receiver_input_channel_3;
    }
    if(receiver_input_channel_4 > 1450 || receiver_input_channel_4 < 1250){
      trigger = 4;
